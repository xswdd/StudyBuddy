...
{
	echo "hi";
	$q="insert into loginform(Name,Email,Department,Username,Password,Confirm_Password) VALUES ('".$_POST['Name']."','".$_POST['Email']."','".$_POST['Department']."','".$_POST['Username']."','".$_POST['Password']."','".$_POST['Confirm_Password']."')";
...
<script language="javascript" type="text/javascript">
	...
	function checkdetails(){
		...
		{
			   alert('Please Enter Minimum 11 Digit Enrollment Number for Username.');
			   Username.focus();
			   return false;
		}
