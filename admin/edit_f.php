...
if(isset($_POST['submit']))
{
    ...
    $sql="update floginform set Name='$Name',Email='$Email',Department='$Department',Username='$Username',Password='$Password',Confirm_Password='$Confirm_Password' where Username='$id2'";
