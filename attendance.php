	...
	<div class="container" id="container">
		...
		<div class="overlay-container">
			<div class="overlay">
				...
				$query = "SELECT * FROM attendance where enrollmentno=$a";
				...
				echo "<tr><td><center>TOC LAB</td><td></center><center>".$j."</center></td></tr>";
				echo "<tr><td><center>AI LAB</td><td></center><center>".$k."</center></td></tr>";
				echo "<tr><td><center>CC LAB</td><td></center><center>".$l."</center></td></tr>";
				echo "<tr><td><center>WT LAB</td><td></center><center>".$m."</center></td></tr>";
				echo "<tr><td><center>IOT LAB</td><td></center><center>".$n."</center></td></tr>";
				echo "</table>";
				echo "</center>";
