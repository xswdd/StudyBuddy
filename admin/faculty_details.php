...
if(isset($POST['submit']))
{
    ...
    $sql="Select * from floginform where Username='$Username'";
...
while($row2=mysqli_fetch_assoc($result))
{
    ...
    echo "<td><a href=edit_f.php?id1=".$row2['Username'].">Edit</a></td>";
    echo "<td><a href=delete_f.php?id1=".$row2['Username'].">Delete</a></td></tr>";
}
}
else{
$sql="Select * from floginform";
$result=mysqli_query($conn,$sql);
echo "<table border=1>";
...
if(isset($_GET['sort']))
{
    $sql="Select * from floginform order by Username";
    $result=mysqli_query($conn,$sql);
    while($row2=mysqli_fetch_assoc($result))
    {
    echo "<tr><td>";
