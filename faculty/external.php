...
if(isset($POST['submit']))
{
    ...
    $sql="Select * from external where enrollmentno='$Username'";
...
while($row2=mysqli_fetch_assoc($result))
{
    ...
    echo "<td><a href=edit2_marks.php?id1=".$row2['enrollmentno'].">Edit</a></td>";
    echo "<td><a href=delete2_marks.php?id1=".$row2['enrollmentno'].">Delete</a></td></tr>";
}
}
else{
...
if(isset($_GET['sort']))
{
    $sql="Select * from external order by Username";
    $result=mysqli_query($conn,$sql);
    while($row2=mysqli_fetch_assoc($result))
    {
    echo "<tr><td>";
