...
$sql="Select * from internal1 where enrollmentno=$id2";
...
if(isset($_POST['submit']))
{
    ...
    $cp=$_POST['t8'];
    $asb=$_POST['t9'];
    $sql="update internal1 set enrollmentno='$enrollmentno',toc='$toc',ai='$ai',cc='$cc',wt='$wt',iot='$iot',uiux='$uiux',cp='$cp',asb='$asb' where enrollmentno='$id2'";
